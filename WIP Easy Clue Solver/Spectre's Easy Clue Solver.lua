...
local clueSteps = {
    ...
    [10182] = function()
        ...
        UTILS.randomSleep(300)
        Inventory:Equip(1137)
        UTILS.randomSleep(300)
        Inventory:Equip(1639)
        UTILS.randomSleep(300)
        while API.Read_LoopyLoop() and GetIdFromEquip(0) ~= 1137 and GetIdFromEquip(7) ~= 1059 and GetIdFromEquip(9) ~= 1639 do
            UTILS.randomSleep(300)
        end
        ...
        while API.Read_LoopyLoop() and GetIdFromEquip(0) == 1137 and GetIdFromEquip(7) == 1059 and GetIdFromEquip(9) == 163 do
            UTILS.randomSleep(300)
        end
    end,
    [10188] = function()
    ...
    [10220] = function()
        ...
        UTILS.randomSleep(1000)
        LODESTONES.ARDOUGNE.Teleport()
        Dive((WPOINT.new(2626 + math.random(-1, 1),3356 + math.random(-1, 1),0)))
        API.DoAction_Tile(WPOINT.new(2624 + math.random(-1, 1),3379 + math.random(-1, 1),0))
        UTILS.randomSleep(1000)
        SurgeIfFacing(360)
        WaitForObjectToAppear(110431, 0)
        API.DoAction_Object1(0x29,API.OFF_ACT_GeneralObject_route0,{110431},50) -- Take items from hidey hole
        ...
        API.DoAction_Tile(WPOINT.new(2614,3385,0))
        while API.Read_LoopyLoop() and not API.PInArea21(2612, 2614, 3384, 3386) do
            UTILS.randomSleep(300)
        end
        Inventory:Equip(1103)
        UTILS.randomSleep(300)
        Inventory:Equip(1694)
        UTILS.randomSleep(300)
        Inventory:Equip(1639)
        UTILS.randomSleep(300)
        while API.Read_LoopyLoop() and GetIdFromEquip(2) ~= 1694 and GetIdFromEquip(4) ~= 1694 and GetIdFromEquip(9) ~= 1639 do
            UTILS.randomSleep(300)
        end
